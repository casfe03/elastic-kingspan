...
RUN pwd
RUN ls -la
RUN /usr/share/logstash/elastic-agent-8.12.2-linux-x86_64/elastic-agent install --silent --url=https://8943fceed2f04dcd82b5bbaf85a6e61b.fleet.eastus2.azure.elastic-cloud.com:443 --enrollment-token=enlSOEdZNEJ3c3dKbmd6b1VvbVg6SUtJemlJNExScjJ4MHQ4cWJaaGhYQQ==
